...
在咨询和应用 AI 工作中，常见问题不是材料不足，而是材料无法回答：要做什么决定、有哪些备选、由谁决定、不决定会怎样、什么证据会改变结论，以及会后留下什么。R2D 为这些要素提供固定结构。
...
它不管理项目进度，也不只是收纳笔记；它帮助作者把证据、判断、备选方案和会后行动放进同一份可审议的材料。它不替代领域知识、法律审查、安全审查或负责人判断。
